...
Домашнее задание включает в себя создание логов и работа с библиотекой logging

## Этапы работы:

 1. Создание ветки homework_12_2.
 2. Работа с библиотекой logging, добавление логирования в masks и utils.
