...
Домашнее задание включает в себя создание декоратора log который будет записывать результат работы функций в filename либо выводить результат в консоль.

## Этапы работы:

 1. Создание ветки homework_11_2.
 2. Создание модулей decorators.py и test_decorators.py.
 3. Написание декоратора и тестов.
